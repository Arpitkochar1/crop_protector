...
try:
    MODEL = tf.keras.models.load_model(r"/Users/arpitkochar/Downloads/Crop-disease-prediction-using-streamlit-main/potatoes.h5", custom_objects={"custom_loss_function": custom_loss_function})
