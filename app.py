...
try:
    MODEL = tf.keras.models.load_model(r"/Users/arpitkochar/Desktop/untitled folder 3/Crop-disease-prediction-using-streamlit/potatoes.h5", custom_objects={"custom_loss_function": custom_loss_function})
